...
//GET /api/routines/:id - get a single routine by id=> API not working for this route
    ...
    try {
      ...
      if (!routineToUpdate) {
        ...
        next({
          name: "WrongUserError",
          message:
            "You must be the same user who created this routine to perform this action",
        });
      } else {
